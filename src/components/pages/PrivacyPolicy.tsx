        ...
        <div className="space-y-6 text-sm text-text-muted leading-relaxed font-sans">
          ...
          <div className="flex gap-4 pt-4 border-t border-gray-50">
            ...
            <div>
              ...
              <p className="mb-2">
                PaisaCalc partners with third-party advertising vendors like Google AdSense to serve monetised advertisement units. Google, as a third-party vendor, uses cookies (including DoubleClick DART cookies) to serve ads to our site visitors based on their visit to mypaisacalc.vercel.app and other sites on the internet.
              </p>
              <p>
          ...
          <div className="pt-4 border-t border-gray-55 space-y-4 font-sans text-xs bg-gray-50 p-4 rounded-xl">
            ...
            <p className="mt-2">
              If you hold queries or request clarifications, feel free to contact us via our secure technical webmaster inbox: <a href="mailto:contact@mypaisacalc.vercel.app" className="underline font-bold text-primary">contact@mypaisacalc.vercel.app</a>.
            </p>
          </div>
        </div>
      </div>
